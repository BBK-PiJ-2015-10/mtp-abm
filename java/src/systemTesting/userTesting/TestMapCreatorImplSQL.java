...
public class TestMapCreatorImplSQL {
	...
	@Before
	public void setUp() {
		configurationManager = new ConfigurationManagerSQL
				(new File("C:\\Users\\YasserAlejandro\\mp\\mtp-abm\\user10sql\\config10"));
		configurationManager.capture("config10");
		setUpStreams();	
	}
...
//These are the test for createMap()
	...
	*/
	...
	public void testcreateMapValidInputs() {
		 ...
		 mapCreator = new MapCreatorImplSQL(false);
