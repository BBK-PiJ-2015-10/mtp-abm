...
import configuration.MapCreatorFactorySQL;
import configuration.MapCreatorAbstract;

public class TestMapCreatorFactorySQL {
	...
	public void initializeFactory(){
		setUpStreams();
		factory = new MapCreatorFactorySQL();
	}
...
///////////////////////////////////////////////////////////////////////////////////////////	
	...
	*/
	...
	public void testgetMapCreatorValidCompleteness1() {	
		assertEquals("configuration.MapCreatorImplSQL",factory.getMapCreator(1).getClass().getName());
		assertEquals("configuration.MapCreatorImplSQL",factory.getMapCreator(2).getClass().getName());
