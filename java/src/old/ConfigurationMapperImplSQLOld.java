...
public class ConfigurationMapperImplSQLOld implements ConfigurationMapperOld {
	
	private ConfigurationManagerSQLOld configurationManager;
	
	private MapCreatorFactorySQLOld mapCreatorFactory = new MapCreatorFactorySQLOld();
	
	private MapCreatorOld mapCreator;
	
	public ConfigurationMapperImplSQLOld(ConfigurationManagerSQLOld configurationManager){
