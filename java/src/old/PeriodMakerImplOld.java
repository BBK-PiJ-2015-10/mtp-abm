...
public class PeriodMakerImplOld implements PeriodMakerOld, Serializable {
	...
	public PeriodMakerImplOld(UserSpace userSpace){
		this.userSpace = userSpace;
	}
	
	public PeriodMakerImplOld(File period){
		this.period=period;
	}
